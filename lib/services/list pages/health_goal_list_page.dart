...
// class HealthGoalListPage extends StatelessWidget {
//   final String healthGoal;
//   final RecipeService _recipeService = RecipeService();

//   HealthGoalListPage({super.key, required this.healthGoal});

//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(
//         title: Text("$healthGoal Recipes"),
//         backgroundColor: Colors.white,
//         elevation: 1.0,
//       ),
//       body: FutureBuilder<List<Recipe>>(
//         future: _recipeService.fetchRecipesByHealthGoal(healthGoal),
//         builder: (context, snapshot) {
//           if (snapshot.connectionState == ConnectionState.waiting) {
//             return const Center(child: CircularProgressIndicator());
//           }
//           if (snapshot.hasError || !snapshot.hasData || snapshot.data!.isEmpty) {
//             return const Center(child: Text("No recipes found for this health goal."));
//           }
...
// lib/health_goal_list_page.dart
...
class HealthGoalListPage extends StatelessWidget {
  ...
  const HealthGoalListPage({super.key, required this.healthGoal});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<QuerySnapshot>(
        // ✅ New Firestore query using 'array-contains' for lists
        future: FirebaseFirestore.instance
            .collection('recipe')
            .where('health_goals', arrayContains: healthGoal)
            .get(),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            return const Center(child: CircularProgressIndicator());
